...
namespace GoogleARCore.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update ()
        {
            //info.text = "why is nothing working";
            ...
            if (m_allPlanes.Count > 0)
                    {
                //xny.text = m_allPlanes[0].Bounds.ToString();
                xny.text = "";
                    }
            else
            {
                xny.text = "no plane found";
            }
            ...
            if (m_allPlanes.Count >0 && fencespawn <1)
            {
                ...
                fencecounter.text = "spawning fence";
                var andyObject = Instantiate(fence, center, Quaternion.identity,
                    anchor.transform);
                fencecounter.text = "fence spawned";
                ...
                fencecounter.text = "attaching";
                andyObject.GetComponent<PlaneAttachment>().Attach(plane);
                fencecounter.text = "attached";
                fence = andyObject;
            }
            if (fence != null)
            {
        ...
        {
            fencecounter.text = "checking fence";
            var tmp = fence;
            if (m_allPlanes.Count < 0)
            {
                return;
            ...
            fencecounter.text = "fence shoould update";
